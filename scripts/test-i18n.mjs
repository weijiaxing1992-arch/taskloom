...
await test('API sends selected language and preserves Headers-instance overrides', async () => {
  ...
  const headers=new Headers({'X-DevFlow-Project':'explicit-project','Accept-Language':'zh-CN'})
  await apiExports.api('/tests',{headers})
  assert.equal(requests[1].headers.get('X-DevFlow-Project'),'explicit-project')
