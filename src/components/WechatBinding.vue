...
<style scoped>
.wechat-binding{width:100%;max-width:680px;min-width:0;box-sizing:border-box}.wechat-binding header{display:block;min-width:0}.wechat-binding h2{margin:0 0 12px;font-size:17px;line-height:1.5}.wechat-binding p{line-height:1.75;overflow-wrap:anywhere}.binding-state{display:grid;gap:8px;padding:16px;border:1px solid var(--border);border-radius:8px;background:var(--secondary);margin:18px 0;min-width:0;overflow-wrap:anywhere}.binding-state small,.binding-help{color:var(--muted-foreground)}.wechat-binding form{display:grid;gap:16px;width:100%;max-width:440px;min-width:0}.wechat-binding label{display:grid;gap:8px;min-width:0}.wechat-binding input{box-sizing:border-box;width:100%;min-width:0;max-width:100%;border:1px solid var(--border);border-radius:6px;padding:8px 10px;background:var(--background);color:var(--foreground);font:inherit}.wechat-binding button{justify-self:start;max-width:100%;white-space:normal;overflow-wrap:anywhere}.wechat-binding [role=alert]{color:var(--destructive)}
</style>
