...
.mention-popup{border-color:var(--line,#d9e0ea);border-radius:5px;background:var(--surface-raised,#fff);color:var(--ink,#26334a);box-shadow:none}.mention-popup>header{padding:6px 8px;border-color:var(--line,#d9e0ea);background:var(--surface-raised,#fff)}.mention-popup>header b{color:inherit}.mention-options{padding:3px;max-height:240px}.mention-options button{min-height:34px;gap:6px;padding:5px 6px;border-radius:3px;background:transparent;color:inherit}.mention-options button.active{background:var(--primary-soft,#eef4ff)}.mention-options button:focus-visible{outline:2px solid var(--primary,#3370eb);outline-offset:-2px}.mention-avatar{width:25px;height:25px;border-radius:4px;background:var(--primary-soft,#eef4ff);color:var(--primary,#3370eb)}.mention-person small{margin-top:1px;color:var(--muted,#758298)}.mention-options em,.mention-popup>header span,.mention-empty{color:var(--muted,#758298)}.mention-empty{padding:10px 8px}.mention-popup>footer{padding:4px 8px;border-color:var(--line,#d9e0ea);color:var(--muted,#758298)}@media(max-width:820px){.mention-options button{min-height:44px}}
</style>
