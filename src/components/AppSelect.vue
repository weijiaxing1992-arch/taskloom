...
<template>
  <Popover :open="open" @update:open="changeOpen">
    <PopoverTrigger as-child>
      <button
        type="button"
        :class="['app-select-trigger', props.class]"
        :disabled="disabled"
        :aria-label="label"
