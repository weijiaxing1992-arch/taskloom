...
export interface WorkspaceSession {
  ...
  user: { id: string; name: string; role: string; avatarColor?: string; locale?: string; timezone?: string; operationDisabled?: boolean; mustChangePassword?: boolean }
  impersonation?: { adminName: string; [key: string]: unknown } | null
